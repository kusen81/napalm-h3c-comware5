...
class ComwareDriver(NetworkDriver):
    ...
    def __init__(
        ...
        if optional_args is None:
            optional_args = {}
            #optional_args = {'transport': 'telnet', 'port': 23} # Added for telnet support

        print("optional_args before")
        print(optional_args)
        ...
        print("optional_args after")
        print(self.netmiko_optional_args)

    def open(self):
        """Open a connection to the device."""
        print("Using optional args:")
        print(self.netmiko_optional_args)
